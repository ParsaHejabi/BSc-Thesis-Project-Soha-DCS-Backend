    ...
    <div class="leaderboard-card ">
      <section class="card-info card-section">
        {username ? (
            ...
            <section class="statistics">
              <article class="statistic">
                ...
                <h3 class="statistic-value">
                  {leaderboardData[userIndex].chatPoints}
                </h3>
              </article>
            </section>
            <div class="dial">
          ...
          <div className="please-login">برای استفاده از فضای چت Login شوید</div>
        )}
      </section>
          ...
          {leaderboardData.map((value, index) => {
            return (
              <div className="leaderboard-row">
                ...
                <div className="leaderboard-col2">{value.chatPoints}</div>
              </div>
            )
          })}
        </dl>
